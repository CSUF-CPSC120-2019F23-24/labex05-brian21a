...
int main()
{
  ...
  std::cout << "\n** The first number starts to drift to 0(underflow), the second is uneffected**" << std::endl;
  std::cout << sizeof(d2) << " bytes, value: " << d2 << std::endl;
  std::cout << sizeof(f2) << " bytes, value: " << f2 << std::endl;
  ...
  std::cout << "\n**The first number drifts to 0(underflow), the second is uneffected**" << std::endl;
  std::cout << sizeof(d2) << " bytes, value: " << d2 << std::endl;
  std::cout << sizeof(f2) << " bytes, value: " << f2 << std::endl;
  ...
  std::cout << "\n**The first number displays infinity because it cannot print 1 significant digit(overflow), The second is uneffected**" << std::endl;
